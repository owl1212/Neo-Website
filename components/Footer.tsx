        ...
        <div className="py-16 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            <Link href="/" className="inline-flex items-center gap-2.5 mb-4">
              <img src="/images/neo-logo.png" alt="NEO" className="h-9 w-9 object-contain" />
            ...
            <div className="mt-6 flex gap-3">
              <a
                ...
                aria-label="Facebook"
                className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center text-[#7a7178] hover:border-[#FF6D29] hover:text-[#FF6D29] transition-colors"
              >
